...
- La música de fondo es una interpretación electrónica sintetizada en tiempo real del motivo de «Oda a la alegría»: no incorpora ninguna grabación externa. La partitura de Mutopia está marcada como dominio público y permite modificarla y distribuirla.
